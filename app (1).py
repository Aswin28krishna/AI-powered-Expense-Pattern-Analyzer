...
st.title("💰 AI-Based Expense Pattern Analyzer")
...
if uploaded_file is not None:
    ...
    st.write(f"Predicted spending: ₹{int(forecast[-1])}")
    ...
    st.write(f"⚠️ You are spending the most on **{highest_cat}**. Consider reducing this category to save money.")
